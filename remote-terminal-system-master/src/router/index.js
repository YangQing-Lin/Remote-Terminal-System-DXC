...
export const constantRoutes = [
    ...
    children: [
      {
        path: "conv",
        name: "conv",
        component: () => import("@/views/conv/conv"),
        meta: { title: "会话管理", icon: "dashboard" },
        hidden: false,
      },
    ],
  },
  ...
  },
  {
    ...
    redirect: '/test/test',
    name: 'test',
    meta: { title: '测试类', icon: 'el-icon-s-help' },
    children: [
      {
        path: 'test',
        name: 'test',
        component: () => import('@/views/test/test'),
        meta: { title: '传参测试', icon: 'table' }
      },
      {
        path: 'api_test',
        name: 'api_test',
        component: () => import('@/views/test/API_test'),
        meta: { title: 'api测试', icon: 'tree' }
      }
    ]
  },
