    ...
    <el-card id="search">
      <el-row>
        ...
        <el-col :span="4" align="right">
          <el-button
            @click="openEditUI('add', true, null)"
            type="primary"
            icon="el-icon-plus"
            circle
          ></el-button>
    ...
    <el-card>
      <el-table :data="roleList" stripe style="width: 100%">
        ...
        <el-table-column label="操作" width="380">
          <template slot-scope="scope">
            <el-button
              @click="openEditUI('eidt', false, scope.row.roleId)"
              id="1"
              type="primary"
              icon="el-icon-edit"
              size="small"
            ...
            >分配权限</el-button>
            <el-button
              @click="openEditUI('eidt', true, scope.row.roleId)"
              type="primary"
              icon="el-icon-edit"
              size="mini"
              circle
...
export default {
  ...
  methods: {
    ...
    openEditUI(method, boolean, id) {
      console.log(method, boolean, id)
      if(method === 'add') {
        this.isadd = boolean
      } else {
        this.isedit = boolean
