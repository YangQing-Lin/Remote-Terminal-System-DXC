<template>
    <div>
        ...
        <el-table class="tablea" :data="logList" style="width: 97%" border>
            <el-table-column prop="name" label="名称" width="180">
            </el-table-column>
            <el-table-column prop="server" label="部署服务器" width="180">
            </el-table-column>
            <el-table-column prop="ip" label="主机" width="180">
            </el-table-column>
            <el-table-column prop="port" label="部署端口">
            </el-table-column>
    ...
    class="bt"
      ...
      :total="40">
        ...
        <el-dialog @close="clearForm" :title="title" :visible.sync="dialogFormVisible" :before-close="handleClose">
            <el-form :model="logForm" ref="logForm">
                ...
                <el-form-item label="部署服务器" prop="server" :label-width="formLabelWidth">
                    <el-input v-model="logForm.server" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="部署端口" prop="port" :label-width="formLabelWidth">
                ...
                <el-form-item label=" 命令" prop="command" :label-width="formLabelWidth">
        ...
        <el-dialog @close="clearForm" :title="title" :visible.sync="dialogFormVisible2" :before-close="handleClose">
            ...
            if (this.name && !this.server) {
                ...
                a.data.forEach((item) => {
                    if (
                        ...
                        item.server.includes(this.server)
                    ) {
                        ilist.push(item);
                    }
                });
